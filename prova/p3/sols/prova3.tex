...
\hline
{\textcolor{red}{\bf 2 1 2 3}} Observe que os quatros últimos dígitos do RGA ocupam a diagonal\\ \hline %2
{\textcolor{red}{\bf 1 0 3 4}} principal da matriz.\\ \hline %2
{\textcolor{red}{\bf 2 3 1 5}}\\ \hline %2
{\textcolor{red}{\bf 3 4 5 4}}\\ \hline %2
...
{\Large\begin{tabular}{|l|}
\hline
{\textcolor{red}{\bf Neste caso, o valor impresso é 11.}}\\ \hline
{\textcolor{red}{\bf A variável x representa a soma dos elementos da matriz localizados na  }}\\ \hline
{\textcolor{red}{\bf coluna que contém o maior valor da matriz.}}\\ \hline
\hspace*{\textwidth} \\ \hline % 1
\end{tabular}}\\
...
{\Large\begin{tabular}{|l|}
\hline
{\textcolor{red}{\bf 15 14 13 12}} \\ \hline %2
{\textcolor{red}{\bf 11 10 09 08}} \\ \hline %2
{\textcolor{red}{\bf 07 06 05 04}}\\ \hline %2
{\textcolor{red}{\bf 03 02 01 00}}\\ \hline %2
\hspace*{\textwidth} \\ \hline % 1
\end{tabular}}
...
\verb+     +\\
\verb+2     if(+ \ovalbox{\color{red}\verb!n == 1!\begin{minipage}{3.5cm}\hfill\vspace{0.8cm}\end{minipage}} \verb+) //Base da recursão+ \\ 
\verb+3          return 0;+\\
\verb+    +\\
\verb+4     return+ \ovalbox{\color{red}\verb! v[n-1] == v[n-2]!\begin{minipage}{1.6cm}\hfill\vspace{0.8cm}\end{minipage}} \verb+||+ \ovalbox{\color{red}\verb! rep(v, n-1)!\begin{minipage}{2.5cm}\hfill\vspace{0.8cm}\end{minipage}}\verb+;+\\
\verb+5 }+\\
%%4     int vetor[4], matriz[4][4], i, j, coluna, x, maior;
%\end{verbatim}
...
\color{red}\verb+int div(int a, int b) {+ \\ \hline
\hspace{1.5cm}\color{red}\verb+if(a <  b) + \\ \hline
\hspace{3cm}\color{red}\verb+return 0; + \\ \hline
\hspace{1.5cm}\color{red}\verb!return 1 + div(a-b, b); ! \\ \hline
\color{red}\verb+} + \\ \hline
\hspace*{\textwidth} \mbox{}\\ \hline %2
\mbox{}\\ \hline %9
\mbox{}\\ \hline %10
\mbox{}\\ \hline %11
\mbox{}\\ \hline %12[commandchars=\\\{\},codes={\catcode`$=3\catcode`^=7\catcode`_=8}]
\mbox{}\\ \hline %13
\mbox{}\\ \hline %14
\mbox{}\\ \hline %15
\mbox{}\\ \hline %16
...
\hspace{1.5cm}\color{red}\verb+int i, j, k = 0; + \\ \hline
\hspace{1.5cm}\color{red}\verb!for(i = 0; i < n; i++)! \\ \hline
\hspace{3cm}\color{red}\verb!for(j = 0; j < n; j++)! \\ \hline
\hspace{4.5cm}\color{red}\verb!matriz[i][j] = frase[k++]; ! \\ \hline
\hspace*{\textwidth} \mbox{}\\ \hline %2
\mbox{}\\ \hline %7
\mbox{}\\ \hline %8
\mbox{}\\ \hline %9
...
\hspace{1.5cm}\color{red}\verb+int i; + \\ \hline
\hspace{1.5cm}\color{red}\verb!for(i = 0; i < n; i++)! \\ \hline
\hspace{3cm}\color{red}\verb!printf("%c", matriz[i][i]);! \\ \hline
\hspace{1.5cm}\color{red}\verb!for(i = 0; i < n; i++)! \\ \hline
\hspace{3cm}\color{red}\verb!printf("%c", matriz[i][n-i-1]);! \\ \hline
